...
void setup(void){
  ...
  wifiMulti.addAP("Oak-zlr", "Oak88888");  // 这三条语句通过调用函数addAP来记录3个不同的WiFi网络信息。
  wifiMulti.addAP("TP-LINK_6472", "gdcjdx105"); // 这3个WiFi网络名称和密码
...
void handleRoot() {       
  esp8266_server.send(200, "text/html", "<form align=\"center\" action=\"/LED\" method=\"POST\"><button style=\"margin-top: 150px;width:400px;height:200px;font-size: 40px;\" type=\"submit\" value=\"switch\">switch</nutton></form>");
}
